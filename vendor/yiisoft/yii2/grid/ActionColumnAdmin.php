 ...
 * @since 2.0
 */
class ActionColumnAdmin extends Column
{
    /**
     ...
     * @see buttons
     */
    public $template = '{viewadmin} {updateadmin} {deleteadmin}';
    /**
    ...
    {
        if (!isset($this->buttons['viewadmin'])) {
            $this->buttons['viewadmin'] = function ($url, $model, $key) {
                $options = array_merge([
        ...
        if (!isset($this->buttons['updateadmin'])) {
            $this->buttons['updateadmin'] = function ($url, $model, $key) {
                $options = array_merge([
        ...
        if (!isset($this->buttons['deleteadmin'])) {
            $this->buttons['deleteadmin'] = function ($url, $model, $key) {
                $options = array_merge([
