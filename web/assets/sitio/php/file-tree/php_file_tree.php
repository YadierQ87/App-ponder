    ...
    if (count($file) > 2)
    {
        ...
        foreach( $file as $this_file )
        {
            ...
            if ($this_file != "." && $this_file != "..")
            {
                ...
                {
                    //Directory
                    $php_file_tree .= "<li class=\"pft-directory\"><a href=\"#\" class = \"nombre-fichero-file-tree\">" . htmlspecialchars($this_file) . "</a>";
                ...
                else
                {
                    ...
                    $php_file_tree .= "<li class=\"pft-file " . strtolower($ext) . "\"><a href=\"" . Url::toRoute(["producto/descargar", "curso" => $curso, 'ruta' => $ruta, "fichero" => htmlspecialchars($this_file)]). "\">" . '<span class = "nombre-fichero-file-tree">' . htmlspecialchars($this_file) . '</span>' . "</a></li>";
                }
            }
        }
        $php_file_tree .= "</ul>";
