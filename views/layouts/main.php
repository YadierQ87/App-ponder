            ...
            <div class="navbar-header">
                ...
                <div style="background-image: url('assets/sitio/imagenes/varias/logo.png'); width: 171px; height: 80px;">
                    <a href="<?= Yii::$app->homeUrl ?>" class="navbar-brand">
                        <?= Html::img('web/assets/sitio/imagenes/varias/logo_vacio.png', ['alt' => 'PonderNET', 'style' => 'margin-top: -20px;']) ?>
                    </a>
                    ...
                    <div class="cart-content" style="width: 55%; float: right">
                        <ul class="scroller">
                            ...
                            <li>
                                <table>
                                    <tr>
                                        <td><strong style="margin-top: -7px;">
                                                <a href="<?= Url::toRoute(['/site/change-language', 'language' => 'fr-FR', 'url' => Url::current()]) ?>">
                                                    <img style="margin-top: -7px;" src="assets/sitio/imagenes/banderas/fr-FR.png">Français</a></strong></td>
                                    </tr>
                                </table>
                            </li>
                            <li>
                                <table>
                                    <tr>
                                        <td><strong style="margin-top: -7px;">
                                                <a href="<?= Url::toRoute(['/site/change-language', 'language' => 'pt-PT', 'url' => Url::current()]) ?>"><img style="margin-top: -7px;" src="assets/sitio/imagenes/banderas/pt-PT.png">Portugu&ecirc;s </a></strong></td>
                                    </tr>
                                </table>
                            </li>
                        </ul>
...
<script>
    $(document).ready(function(){
      ...
      var munics = <?= \app\controllers\StaticMembers::CargarNomenclador("munic") ?>;
        ...
        //console.log('si');
       // var set= setTimeout(alert('Si'),9000);
