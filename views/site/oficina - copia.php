...
<div class="site-contact">
    ...
    <div class="container">
        <?/*= SiteController::translate('Affiliate link: ') ?> <code><?= Html::a(Url::home(true) . "site/usuario/" . Yii::$app->user->identity->username /*. 'site/usuario/' . Yii::$app->user->identity->username*//*, Url::toRoute(['site/usuario', 'id' => Yii::$app->user->identity->username]))*/ ?>
        <!--</code><br/><br/>-->
