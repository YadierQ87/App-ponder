...
<div class="producto-view">   
    ...
    <?= Html::beginForm('https://www.paypal.com/cgi-bin/webscr', "post")?>
        ...
        <?= Html::input("hidden", "business", $cuenta_paypal) ?>
        ...
        <?= Html::input("hidden", "return", Url::toRoute(['producto/ipn-ponder'])) ?>
        <?= Html::input("hidden", "cancel_return", Url::toRoute(['producto/comprar', 'id' => $model->id])) ?>
        <?= Html::input("hidden", "notify_url", Url::toRoute(['producto/ipn-ponder'])) ?>
